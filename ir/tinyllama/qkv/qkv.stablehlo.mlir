module @jit_qkv_projection attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<1x16x2048xf32>, %arg1: tensor<2048x2048xf32>, %arg2: tensor<2048x256xf32>, %arg3: tensor<2048x256xf32>) -> (tensor<1x32x16x64xf32> {jax.result_info = "result[0]"}, tensor<1x4x16x64xf32> {jax.result_info = "result[1]"}, tensor<1x4x16x64xf32> {jax.result_info = "result[2]"}) {
    ...
    %6 = stablehlo.transpose %3, dims = [0, 2, 1, 3] : (tensor<1x16x32x64xf32>) -> tensor<1x32x16x64xf32>
    %7 = stablehlo.transpose %4, dims = [0, 2, 1, 3] : (tensor<1x16x4x64xf32>) -> tensor<1x4x16x64xf32>
    %8 = stablehlo.transpose %5, dims = [0, 2, 1, 3] : (tensor<1x16x4x64xf32>) -> tensor<1x4x16x64xf32>
    return %6, %7, %8 : tensor<1x32x16x64xf32>, tensor<1x4x16x64xf32>, tensor<1x4x16x64xf32>
  }
}
